...
![Serdar Balci](https://avatars0.githubusercontent.com/u/7208830?s=400&v=4){width=80%}


Contact Info {#contact}
--------------------------------------------------------------------------------

- <i class="fa fa-envelope"></i> drserdarbalci@gmail.com
- <i class="fa fa-github"></i> [github.com/sbalci](https://github.com/sbalci)
- <i class="fa fa-phone"></i> +90 533 447 20 96
- For more information, please contact me via [email](drserdarbalci@gmail.com).
...
- Medical Doctor, Pathologist, Associated Professor

- Experienced in pancreatobiliary and gastrointestinal pathology

- Interested in:
  - Statistics and bioinformatic tools in anatomic pathology,
  - Digital pathology
  - Quality Control in pathology

- Skilled in Project Planning, Research Planning, Data Collection, Analysis, and Presentation

- Skilled in softwares: R, IBM SPSS, MedCalc, SEERStat
...
### Currently searching for a pathologist and researcher position
