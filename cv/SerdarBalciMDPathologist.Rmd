...
<!-- <meta name="google-site-verification" content="sxDq--zDsZd6htw4datz5MmUspOSVpmnDvVo-L7rVdU" /> -->
...
### Genel Uğraşılar {#guncel-ugrasilar}
...
### Güncel Uğraşılar {#genel-ugrasilar}

- [Histopathology Research Template](https://github.com/sbalci/histopathology-template)  
...
- [Patreon](https://www.patreon.com/sbalci)  
...
<a href="https://www.patreon.com/bePatron?u=11237306" data-patreon-widget-type="become-patron-button">Become a Patron!</a><script async src="https://c6.patreon.com/becomePatronButton.bundle.js"></script>
...
### Web & Social Media Accounts {#web-social-links}
...
#### Other Research Accounts {#research-accounts}
...
- [SourceForge](https://sourceforge.net/u/serdarbalci/profile/)
...
"In GOTT vertrauen wir, alle anderen müssen Daten mitbringen" -->
...
- [Lens Scholar](https://www.lens.org/lens/scholar/search/results?collectionId=170675)
...
Read-Write link
   http://visualbib.uniud.it/en/visualbib2/?id=8e44ed2086640b5962b573b34267f266 ⟸ CLICK ON THIS TO CONTINUE EDITING THE SAVED VERSION

Read-Only link
   http://visualbib.uniud.it/en/visualbib2/?id=c22cef766037d3a918056157466db2e4

Embed code (change the width and height attributes to adapt the size)
   <iframe width="995" height="929" src="http://visualbib.uniud.it/visualBib2/visualBib.min.html?id=c22cef766037d3a918056157466db2e4&embed=1" frameborder="0" >
   </iframe>

IMPORTANT NOTES:
   - store the Read-Write link for future accessing / editing the bibliography;
   - click on it to continue editing the saved version;
   - the links of all the saved bibliographies can be received via email using the 'List my bib' function.
...
-  Taskin OC, Bellolio E, Dursun N, Seven IE, Roa JC, Araya JC, Villaseca M, Tapia O, Vance C, Saka B, Balci S, Bagci P, Losada H, Sarmiento J, Memis B, Pehlivanoğlu B, Basturk O, Reid MD, Koshiol J, Cheng JD, Kapran Y, Adsay V. Non-neoplastic Polyps of the Gallbladder: A Clinicopathologic Analysis of 447 Cases. Am J Surg Pathol. 2019 Nov 12;. doi: 10.1097/PAS.0000000000001405. [Epub ahead of print] PubMed PMID: 31725469. 


-  Tuncel D, Basturk O, Bradley KT, Kim GE, Xue Y, Reid MD, Balci S, Erbarut I, Adsay V. Poorly Cohesive (Signet Ring Cell) Carcinoma of the Ampulla of Vater. Int J Surg Pathol. 2019 Oct 15;:1066896919880968. doi: 10.1177/1066896919880968. [Epub ahead of print] PubMed PMID: 31612756.  https://journals.sagepub.com/doi/abs/10.1177/1066896919880968



-  Taskin OC, Akkas G, Memis B, Seven IE, Basturk O, Jang KT, Roa JC, Araya JC, Bellolio E, Losada H, Sarmiento J, Balci S, Pehlivanoglu B, Reid MD, Koshiol J, Adsay V. Sarcomatoid carcinomas of the gallbladder: clinicopathologic characteristics. Virchows Arch. 2019 Jun 8;. doi: 10.1007/s00428-019-02583-z. [Epub ahead of print] PubMed [PMID: 31177317](https://www.ncbi.nlm.nih.gov/pubmed/31177317). 
...
#### Uluslararası kongrelerdeki poster sunumları {#posters}
...
- [Pathophysiology of peritoneal endometriosis pain](https://www.endonews.com/pathophysiology-of-peritonealendometriosis-pain)



### R-project Codes & Projects {#r-project-codes}


#### Pages {#r-project-pages}


#### Presentations {#r-project-presentations}


#### Shares {#r-project-shares}

https://twitter.com/search?q=from%3Aserdarbalci%20%23rstats

#### Github {#r-project-github}


#### Docker Images {#r-project-docker}
